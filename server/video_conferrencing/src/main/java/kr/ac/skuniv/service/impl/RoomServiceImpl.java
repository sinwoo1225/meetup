...
import kr.ac.skuniv.dto.ScriptDto;
...
public class RoomServiceImpl implements RoomService {
	...
	@Value("nlp.server.host")
	private String NLP_SERVER_HOST;
	...
	// 시간순으로 스크립트 정렬
	private ScriptDto.Info sortScript(List<String> originScripts) {
	...
	public void collectScript(String roomCode, WebSocketSession session, String script) throws Exception {
		...
		ScriptDto.Info scriptInfo = sortScript(originScripts);

        Map<String, String> requestMap = new HashMap<>();
        requestMap.put("script", scriptInfo.getScript());
        ...
        String tags = restTemplate.postForObject("NLP_SERVER_HOST", entity, String.class);
        ...
        response.put("script", scriptInfo.getResult());
