...
/*
        if (!Camera2Enumerator.isSupported(this)) {
            Preference camera2Preference = settingFragment.findPreference(keyprefCamera2);
        ...
        if (!JavaAudioDeviceModule.isBuiltInAcousticEchoCancelerSupported()) {
            Preference disableBuiltInAECPreference =
                    settingFragment.findPreference(keyprefDisableBuiltInAEC);
        ...
        Preference disableBuiltInAGCPreference =
                settingFragment.findPreference(keyprefDisableBuiltInAGC);
        ...
        if (!JavaAudioDeviceModule.isBuiltInNoiseSuppressorSupported()) {
            Preference disableBuiltInNSPreference =
                    settingFragment.findPreference(keyprefDisableBuiltInNS);
    ...
    private void updateSummary(SharedPreferences sharedPreferences, String key) {
        Preference updatedPref = settingFragment.findPreference(key);
        // Set summary to be the user-description for the selected value
    ...
    private void updateSummaryList(SharedPreferences sharedPreferences, String key) {
        ListPreference updatedPref = (ListPreference) settingFragment.findPreference(key);
    ...
    private void setVideoBitrateEnable(SharedPreferences sharedPreferences) {
        Preference bitratePreferenceValue =
                settingFragment.findPreference(keyprefMaxVideoBitrateValue);
    ...
    private void setAudioBitrateEnable(SharedPreferences sharedPreferences) {
        Preference bitratePreferenceValue =
                settingFragment.findPreference(keyprefStartAudioBitrateValue);
    ...
    private void setDataChannelEnable(SharedPreferences sharedPreferences) {
        ...
        settingFragment.findPreference(keyprefOrdered).setEnabled(enabled);
        settingFragment.findPreference(keyprefMaxRetransmitTimeMs).setEnabled(enabled);
        settingFragment.findPreference(keyprefMaxRetransmits).setEnabled(enabled);
        settingFragment.findPreference(keyprefDataProtocol).setEnabled(enabled);
        settingFragment.findPreference(keyprefNegotiated).setEnabled(enabled);
        settingFragment.findPreference(keyprefDataId).setEnabled(enabled);
    }
}
